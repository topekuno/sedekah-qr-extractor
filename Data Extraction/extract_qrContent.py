...
def main(pdf_path, output_json_path):
    ...
    print(f"Extracted {len(qr_codes)} QR codes. Results saved to {output_json_path}")

if __name__ == "__main__":
    pdf_path = "Main_PDF.pdf" # Input PDF file
    output_json_path = "Main_PDF_output.json" # Output JSON file
